...
const header = () => {
  ...
  const notify = () => toast('Login here ...')
  return <>
    <header className="navbar-top p-2 heading-color">
      <div className="container-xxl">
        <div className="row">
          <div className="d-flex align-items-center justify-content-between d-none d-md-flex">
            <div className="col-md-8 me-auto">
              <p>The trending outfits at 70% off</p>
            </div>
            <div className="col-md-2">
              <a className='black' href="tel:+254708118414">Call us at +91 - 980111815</a>
            </div>
    ...
    <header className="navbar-middle sticky-top p-2 p-md-2 p-lg-2 navbar-color">
      <div className="container-xxl">
        <div className="row align-items-center m-0">
          <div className="col-md-2 d-flex justify-content-center">
            ...
            <Link to='/'>
              <img src={logo} alt="logo" className="img-fluid  logo-height" />
            </Link>
          ...
          <div className="col-md-10 row col-lg-10">
            ...
            <div className="col-md-6 m-auto">
              <div className='menu-links mt-2 d-none d-md-flex d-lg-flex'>
                ...
                {/* <div className='ms-auto gap-3'><button  onClick={}>logout</button></div>
                 */}
                <div className='ms-auto gap-3'>
                  {!session ? (
                    ...
                    <button
                      className='button block is-mega-menu btn btn-primary'
                      onClick={() => {
                        localStorage.clear()
