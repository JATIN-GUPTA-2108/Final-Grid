          ...
          <div className="d-flex flex-column justify-content-center ">
            <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                  ...
                  <p className='mb-3'>Save more today with World Store</p>
    ...
    <div className="container-xxl">
      <div className="row">
        <div className="col-12 text-center">
          ...
          <p> New Modern Designs For All Weathers</p>
        </div>
       <Featuredproducts />
      </div>
    </div>
    ...
    <div className="container-xxl">
      <div className="row ">
        <div className="repair-details text-center align-items-center">
          <h5 className='mb-3 text-white'>Affordable Price</h5>
    ...
    <div className="container-xxl">
      <div className="row">
        <div className="col-md-6 d-flex">
                  <div className="card m-auto mb-3 hot-item">
        ...
        <div className="col-md-6 d-flex">
                  <div className="card mb-3 hot-item">
            <div className="row g-0">
              <div className="col-md-4">
